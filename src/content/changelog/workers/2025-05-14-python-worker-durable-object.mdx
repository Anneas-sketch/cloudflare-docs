...
You can now create Durable Objects using Python. A Durable Object is a special kind of
...
Consult the [Durable Objects page](/durable-objects/) for full details on Durable Objects.